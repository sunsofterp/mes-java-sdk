...
public class RbsRequest extends RequestObject {
	 ...
	 * </ul>
	 */
	public static enum RequestType { CREATE, UPDATE, INQUIRY, DELETE };
	 ...
	 * </ul>
	 */
	public static enum PaymentFrequency { MONTHLY, QUARTERLY, ANNUALLY }
	
	/**
	 * The payment method to bill: Credit Card, or ACH.
	 */
	public static enum PaymentType { CC, ACHP }
	...
	public RbsRequest setAchData(String accountNum, String transitNum, AchAccountType accountType, AchAuthType authType) {
		...
		switch(accountType) {
		case CHECKING: setParameter("account_type", "C"); break;
		case SAVINGS: setParameter("account_type", "S"); break;
		}
		
		switch(authType) {
		case WEB: setParameter("auth_type", "WEB"); break;
		case CCD: setParameter("auth_type", "CCD"); break;
		case PPD: setParameter("auth_type", "PPD"); break;
		}
		return this;
	}
